  ...
  int? getValueByString(String label) {
    ...
    switch (label) {
      ...
      case 'logFileStats.flutterChannelCount':
        return (key != null && flutterChannelCount.containsKey(key))
            ? flutterChannelCount[key]
            : null;
      case 'logFileStats.toolCount':
        return (key != null && toolCount.containsKey(key))
            ? toolCount[key]
            : null;
      case 'logFileStats.eventCount':
        return (key != null && eventCount.containsKey(key))
            ? eventCount[key]
            : null;
      default:
        return null;
